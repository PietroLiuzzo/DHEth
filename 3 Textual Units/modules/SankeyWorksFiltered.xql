...
{for $W in $datedW 
let $root := root($W)[descendant::t:term[@key=$filter]]
...
{for $work in $W 
let $id := string($work/ancestor::t:TEI/@xml:id)
return 
...
<div class="col-md-12 alert alert-info">
            ...
            <p class="lead">Selection of works with period keyword.</p>
