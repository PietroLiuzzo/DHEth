<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:t="http://www.tei-c.org/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:local="this.transformation" exclude-result-prefixes="xs" version="2.0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <xsl:for-each select="t:certainty">
                        ...
                        <xsl:variable name="r" select="substring-after(@resp,'#')"/>
                        <tr>
